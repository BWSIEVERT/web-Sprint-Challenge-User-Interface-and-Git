...
Semantic HTML basically makes the webpage have meaning, importance or emphasis...

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Inline are within the existing element. Block is its own and takes up the entire width..
...
cross-axis or vertical

5. Explain why git is valuable to a team of developers.

It allows teams to collaborate with each other. It also makes organising commits/edits easier.
